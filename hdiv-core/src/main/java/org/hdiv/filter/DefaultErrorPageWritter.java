...
public class DefaultErrorPageWritter {
	...
	public void writeErrorPage(final HttpServletRequest request, final PrintWriter out, final List<ValidatorError> editableErrors) {
        ...
        out.write(".error-page .error-box{\n"+
        ...
        out.write(".error-page .icon-box {\n"+
        "    margin-left: -190px;\n"+
        "    position: absolute;\n"+
        "    width: 160px;\n"+
        "}\n");

        out.write(".error-page .icon-box img {\n"+
        "    display: block;\n"+
        "    margin: 40px auto 0;\n"+
        "}\n"+
        "img {\n"+
        ...
        out.write(".error-page .error-box h1 {\n"+
        "    display: block;\n"+
        "    font-size: 19px;\n"+
        "    font-weight: 600;\n"+
        "    line-height: 20px;\n"+
        ...
        out.write(".error-page .message-box{\n"+
        "    background: white; \n"+
        ...
        out.write("	<header><img style=\"padding-left: 50px\" src=\"" + logoHeader + "\" /></header>");
        out.write("        <section class=\"error-box\">");
        ...
        out.write("			<div class=\"icon-box\"><img src=\"" + logo + "\" height=\"75\" width=\"75\" /></div>");
        out.write("            <div class=\"message-box\">");
        out.write("            <h1>Unauthorized access</h1>");

        out.write("            <div style=\"margin-top:58px;\">");
        out.write("                <a href=\"javascript: window.history.back()\" class=\"btn btn-primary btn-small\"><i class=\"icon-long-arrow-left\"></i> Go back</a>&nbsp;&nbsp;");
        out.write("                <a href=\"" + request.getContextPath() + "\" class=\"btn btn-small\">Home</a>");
        out.write("            </div>");
