...
public class SharedHdivException extends RuntimeException {
	...
	public SharedHdivException(final String message) {
		super(message);
		// TODO Auto-generated constructor stub
	}

	public SharedHdivException(final Throwable cause) {
		super(cause);
		// TODO Auto-generated constructor stub
	}

	public SharedHdivException(final String message, final Throwable cause) {
		super(message, cause);
		// TODO Auto-generated constructor stub
	}
