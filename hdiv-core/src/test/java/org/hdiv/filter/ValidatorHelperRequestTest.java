...
public class ValidatorHelperRequestTest extends AbstractHDIVTestCase {
    ...
    /**
     * This method check if hasNonConfidentialIncorrectValues method can receive
     * repeated values in the last 2 positions.
     */
	...
	ValidatorHelperResult actualResult = ((ValidatorHelperRequest) helper)
		.hasNonConfidentialIncorrectValues(targetName, parameter, values, tempStateValues);
	assertFalse(actualResult.isValid());
	assertEquals(HDIVErrorCodes.REPEATED_VALUES, actualResult.getErrorCode());
    }

    /**
     * This method check if hasNonConfidentialIncorrectValues method can receive
     * repeated values in the middle of received array values.
     */
    ...
    /**
     * This method check if hasNonConfidentialIncorrectValues method can receive
     * repeated values at first positions of received array values.
     */
    ...
    /**
     * This method check that hasNonConfidentialIncorrectValues method returns
     * invalid result when unexpected value is received for specific parameter.
     */
	...
	ValidatorHelperResult actualResult = ((ValidatorHelperRequest) helper)
		.hasNonConfidentialIncorrectValues(targetName, parameter, values, tempStateValues);
	assertFalse(actualResult.isValid());
	assertEquals(HDIVErrorCodes.PARAMETER_VALUE_INCORRECT, actualResult.getErrorCode());
    }
