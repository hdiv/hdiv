...
public class HDIVTilesRequestProcessor extends TilesRequestProcessor {
    ...
    /**
     * Property that contains the error message to be shown by Struts when the
     * value of the editable parameter is not valid.
     */
    private static final String HDIV_EDITABLE_ERROR = Constants.HDIV_EDITABLE_ERROR_KEY;

    /**
     * Property that contains the error message to be shown by Struts when the
     * value of the editable password parameter is not valid.
     */
     ...
     * @exception InvalidCancelException
     ...
     * the Struts' actionForward call. It checks if the actionForward is done on
     * a Tiles definition name. If true, process the definition and insert it.
     * If false, call the original parent's method.
     * 
     * @param request The servlet request we are processing.
