...
/**
 * <p>
 * Renders an HTML &lt;input&gt; element of type <code>checkbox</code>, whose
 ...
 * </p>
 * <p>
 * <strong>WARNING</strong>: In order to correctly recognize cases where none of the
 * associated checkboxes are selected, the <code>ActionForm</code> bean associated
 * with this form must include a statement setting the corresponding array to zero
 * length in the <code>reset()</code> method.
 * </p>
 * <p>
 ...
 * </p>
 * <ul>
 * <li>Specify a <code>value</code> attribute, whose contents will be used
 * literally as the value to be returned.</li>
 * <li>Specify no <code>value</code> attribute, and the nested body content of
 * this tag will be used as the value to be returned.</li>
 * </ul>
 * 
