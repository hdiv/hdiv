...
/**
 * This is the <code>BeanInfo</code> descriptor for the <code>org.hdiv.strutsel.taglib.html.ELTextareaTagHDIV</code> class. It is needed to
...
public class ELTextareaTagHDIVBeanInfo extends SimpleBeanInfo {
	...
	public PropertyDescriptor[] getPropertyDescriptors() {
		...
		try {
			proplist.add(new PropertyDescriptor("errorStyleClass", ELTextareaTagHDIV.class, null, "setErrorStyleClassExpr"));
		}
		catch (IntrospectionException ex) {
		}
