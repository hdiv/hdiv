...
import org.hdiv.taglib.html.FileTagHDIV;

/**
 * Custom tag for input fields of type "file".
 * <p>
 * This class is a subclass of the class <code>org.hdiv.struts.taglib.html.FileTagHDIV</code> which provides most of the described
...
public class ELFileTagHDIV extends FileTagHDIV {
	...
	private void evaluateExpressions() throws JspException {
		...
		if ((string = EvalHelper.evalString("accept", getAcceptExpr(), this, pageContext)) != null) {
			setAccept(string);
		}
