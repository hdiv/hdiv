...
import org.hdiv.taglib.html.RadioTagHDIV;

/**
 * Tag for input fields of type "radio".
 * <p>
 * This class is a subclass of the class <code>org.hdiv.taglib.html.RadioTagHDIV</code> which provides most of the described functionality.
 ...
 * @since HDIV 2.0
 */
public class ELRadioTagHDIV extends RadioTagHDIV {
	...
	private void evaluateExpressions() throws JspException {
		...
		if ((string = EvalHelper.evalString("idName", getIdNameExpr(), this, pageContext)) != null) {
			setIdName(string);
		}
