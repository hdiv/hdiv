...
import org.hdiv.taglib.html.PasswordTagHDIV;

/**
 * Custom tag for input fields of type "password".
 * <p>
 * This class is a subclass of the class
 * <code>org.hdiv.taglib.html.PasswordTagHDIV</code> which provides most of
 ...
 * @since HDIV 2.0
 */
public class ELPasswordTagHDIV extends PasswordTagHDIV {
	...
	/**
	 * Getter method for "redisplay" tag attribute. (Mapping set in associated
	 * BeanInfo class.)
	 */
	public String getRedisplayExpr() {
		return (redisplayExpr);
	}
	...
	/**
	 * Setter method for "redisplay" tag attribute. (Mapping set in associated
	 * BeanInfo class.)
	 */
	...
	private void evaluateExpressions() throws JspException {
		...
		if ((string = EvalHelper.evalString("maxlength", getMaxlengthExpr(), this, pageContext)) != null) {
			setMaxlength(string);
		}
		...
		if ((bool = EvalHelper.evalBoolean("redisplay", getRedisplayExpr(), this, pageContext)) != null) {
