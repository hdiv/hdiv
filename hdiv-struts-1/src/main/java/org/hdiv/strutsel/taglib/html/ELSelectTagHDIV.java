 ...
 * @since HDIV 2.0
 */
public class ELSelectTagHDIV extends SelectTagHDIV {
	...
	/**
	 * Getter method for "multiple" tag attribute. (Mapping set in associated BeanInfo class.)
	 */
	...
	/**
	 * Setter method for "multiple" tag attribute. (Mapping set in associated BeanInfo class.)
	 */
	...
	private void evaluateExpressions() throws JspException {
		...
		if ((string = EvalHelper.evalString("multiple", getMultipleExpr(), this, pageContext)) != null) {
			setMultiple(string);
		}
