...
/**
 * This is the <code>BeanInfo</code> descriptor for the <code>org.hdiv.strutsel.taglib.html.ELPasswordTagHDIV</code> class. It is needed to
...
public class ELPasswordTagHDIVBeanInfo extends SimpleBeanInfo {
	...
	public PropertyDescriptor[] getPropertyDescriptors() {
		...
		try {
			proplist.add(new PropertyDescriptor("errorStyleClass", ELPasswordTagHDIV.class, null, "setErrorStyleClassExpr"));
		}
		catch (IntrospectionException ex) {
		}
