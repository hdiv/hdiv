...
/**
 * This is the <code>BeanInfo</code> descriptor for the <code>org.apache.strutsel.taglib.html.ELCheckboxTag</code> class. It is needed to
...
public class ELCheckboxTagHDIVBeanInfo extends SimpleBeanInfo {
	...
	public PropertyDescriptor[] getPropertyDescriptors() {
		...
		try {
			proplist.add(new PropertyDescriptor("errorStyleClass", ELCheckboxTagHDIV.class, null, "setErrorStyleClassExpr"));
		}
		catch (IntrospectionException ex) {
		}
