...
/**
 * Tag for select options. The body of this tag is presented to the user in the
 * option list, while the value attribute is the value returned to the server if
 * this option is selected.
 * <p>
 * This class is a subclass of the class
 * <code>org.hdiv.taglib.html.OptionTagHDIV</code> which provides most of the
