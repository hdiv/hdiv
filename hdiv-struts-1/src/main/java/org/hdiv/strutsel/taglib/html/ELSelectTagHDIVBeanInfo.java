...
/**
 * This is the <code>BeanInfo</code> descriptor for the <code>org.hdiv.strutsel.taglib.html.ELSelectTagHDIV</code>
...
public class ELSelectTagHDIVBeanInfo extends SimpleBeanInfo {
	...
	public PropertyDescriptor[] getPropertyDescriptors() {
		...
		try {
			proplist.add(new PropertyDescriptor("errorStyleClass", ELSelectTagHDIV.class, null,
