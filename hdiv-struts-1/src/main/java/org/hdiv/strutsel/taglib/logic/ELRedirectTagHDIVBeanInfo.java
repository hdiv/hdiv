...
/**
 * This is the <code>BeanInfo</code> descriptor for the <code>org.hdiv.strutsel.taglib.logic.ELRedirectTagHDIV</code> class. It is needed to
...
public class ELRedirectTagHDIVBeanInfo extends SimpleBeanInfo {
	...
	public PropertyDescriptor[] getPropertyDescriptors() {
		...
		try {
			proplist.add(new PropertyDescriptor("useLocalEncoding", ELRedirectTagHDIV.class, null, "setUseLocalEncodingExpr"));
		}
		catch (IntrospectionException ex) {
		}
