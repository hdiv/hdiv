...
import org.hdiv.taglib.html.TextareaTagHDIV;

/**
 * Custom tag for input fields of type "textarea".
 * 
 * <p>
 * This class is a subclass of the class <code>org.hdiv.taglib.html.TextareaTagHDIV</code> which provides most of the described
 ...
 * @since HDIV 2.0
 */
public class ELTextareaTagHDIV extends TextareaTagHDIV {
	...
	/**
	 * Getter method for "cols" tag attribute. (Mapping set in associated BeanInfo class.)
	 */
	...
	/**
	 * Getter method for "rows" tag attribute. (Mapping set in associated BeanInfo class.)
	 */
	...
	/**
	 * Setter method for "cols" tag attribute. (Mapping set in associated BeanInfo class.)
	 */
	...
	/**
	 * Setter method for "rows" tag attribute. (Mapping set in associated BeanInfo class.)
	 */
	...
	private void evaluateExpressions() throws JspException {
		...
		if ((string = EvalHelper.evalString("cols", getColsExpr(), this, pageContext)) != null) {
			setCols(string);
		}
		...
		if ((string = EvalHelper.evalString("onselect", getOnselectExpr(), this, pageContext)) != null) {
			setOnselect(string);
		}
		...
		if ((string = EvalHelper.evalString("rows", getRowsExpr(), this, pageContext)) != null) {
			setRows(string);
		}
		...
		if ((string = EvalHelper.evalString("size", getSizeExpr(), this, pageContext)) != null) {
			setSize(string);
		}
