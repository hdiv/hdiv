...
import org.hdiv.taglib.html.HiddenTagHDIV;

/**
 * Custom tag for input fields of type "hidden".
 * <p>
 * This class is a subclass of the class
 * <code>org.hdiv.taglib.html.HiddenTagHDIV</code> which provides most of the
 ...
 * @since HDIV 2.0
 */
public class ELHiddenTagHDIV extends HiddenTagHDIV {
	...
	/**
	 * Getter method for "write" tag attribute. (Mapping set in associated
	 * BeanInfo class.)
	 */
	...
	/**
	 * Setter method for "write" tag attribute. (Mapping set in associated
	 * BeanInfo class.)
	 */
	...
	private void evaluateExpressions() throws JspException {
		...
		if ((bool = EvalHelper.evalBoolean("write", getWriteExpr(), this, pageContext)) != null) {
